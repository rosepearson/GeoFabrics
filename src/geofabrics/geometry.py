...
class CatchmentGeometry:
    ...
    def _set_up(self):
        ...
        assert len(self._catchment) == 1, "The catchment is made of multiple separate polygons it must be a single polygon object - a MultiPolygon is fine"
    ...
    def land_and_foreshore_without_lidar(self, lidar_extents):
        ...
        land_and_foreshore_without_lidar = geopandas.overlay(self.land_and_foreshore, land_and_foreshore_with_lidar, how="difference")
    ...
    def offshore_dense_data_edge(self, lidar_extents):
        ...
        dense_data_extents = geopandas.GeoDataFrame(index=[0],
                                                    geometry=geopandas.GeoSeries(shapely.ops.cascaded_union([self.foreshore.loc[0].geometry,
...
class BathymetryContours:
    ...
    def _set_up(self, exclusion_extent):
        ...
        assert self._points_label not in self._contour.columns, "The bathymetry data already has a points column that will be overridden"
