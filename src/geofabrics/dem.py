...
class ReferenceDem:
    ...
    def __init__(self, dem_file, catchment_geometry: geometry.CatchmentGeometry, set_foreshore: bool = True, exclusion_extent = None):
    ...
    def _set_up(self, exclusion_extent):
        ...
        if exclusion_extent is not None:
            ...
            self._extent = geopandas.overlay(self.catchment_geometry.land_and_foreshore, exclusion_extent, how="difference")
        else:
...
class DenseDem:
    ...
    def __init__(self, catchment_geometry: geometry.CatchmentGeometry, temp_raster_path: typing.Union[str, pathlib.Path], verbose: bool = True):
