...
class LinzTiles:
    ...
    def query_vector_inside_radius(self, x: float, y: float, radius: float):
        """ Function to check for tiles in search radius using the Koordinates vector query API
    ...
    def query_vector_inside_bounds(self, bounds):
    ...
    def get_tiles_inside_catchment(self):
        ...
        feature_collection = self.query_vector_inside_bounds(catchment_bounds)
    ...
    def get_tiles_inside_catchment_json(self):
        """ Get a list of tiles within the catchment boundary """
