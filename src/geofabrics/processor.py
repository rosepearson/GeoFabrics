...
class GeoFabricsGenerator:
    ...
    def run_local_datapaths(self):
        ...
        interpolated_dem = combined_dem.rio.interpolate_na() 
        self.result_dem = interpolated_dem.rio.clip(self.catchment_geometry.catchment.geometry)
