...
class Test1(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        assert cls.cache_dir.exists(), "The data directory that should include the comparison benchmark dem file doesn't exist"
        ...
        pdal_pipeline_instructions = [
            {"type":  "writers.las", "a_srs": "EPSG:" + str(cls.instructions['instructions']['projection']),"filename": str(lidar_file), 
             "compression": "laszip"}
        ]
